    ...
    <div className="bg-white shadow sm:rounded-lg mt-8">
      ...
      <div className="p-6">
        {activeTab === 'risks' ? (
          <div>
            ...
            {risks.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="mt-1 text-sm text-gray-500">Click the analyze button to check for potential risks.</p>
              </div>
            )}
          </div>
        ) : (
          <div>
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-medium text-gray-900">Simple Document Summary</h3>
              <div className="flex space-x-4">
                <button
                  type="button"
            ...
            {summary ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="mt-1 text-sm text-gray-500">Click the generate button to create a simplified summary.</p>
              </div>
            )}
          </div>
        )}
