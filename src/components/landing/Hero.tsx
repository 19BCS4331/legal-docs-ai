        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Skip the expensive lawyer fees. Generate professional, legally-sound contracts instantly using our AI-powered platform. Perfect for businesses, freelancers, and individuals.
            </p>
